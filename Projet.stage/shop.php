...
<body class="">
    ...
    <header
        class="  w-full flex items-center  fixed h-17 text-black justify-between py-5 shadow-lg bg-[#e3e6f3]  z-50">
    ...
    <section
        class=" font-quick  w-full h-[40vh] md:h-[30vh] lg:h-[30vh] flex text-cyan-50 justify-between flex-wrap  items-center pl-16 bg-[#041e42] bg-[url(./images/banner/b14.png)] bg-position-[20%]  bg-no-repeat bg-cover  my-8">
        <div class="">
    ...
    <div id="cart-toast" class="fixed bottom-18 right-5  text-center bg-gray-600 text-white px-4 py-3 rounded-md shadow-lg hidden z-50">
    ...
    <script>
        ...
        document.querySelectorAll('button[value="add_wishlist"]').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                fetch('add_to_wishlist.php', {
                    ...
                    .then(data => {
                        ...
                        let message = document.getElementById('wishlist-toast-message');
        ...
        document.querySelectorAll('button[value="add_cart"]').forEach(button => {
            button.addEventListener('click', function(e) {
                e.preventDefault();
                let form = this.closest('form');
                let formData = new FormData(form);
