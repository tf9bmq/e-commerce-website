...
<body class="font-quick">
    ...
    <header
        class="top-0  w-full flex items-center  fixed h-17 text-black justify-between py-5 header-shadow  bg-[#e3e6f3]  z-50">
    ...
    <section
        class="lg:py-18 lg:px-22 p-6 flex flex-wrap items-center md:items-start md:flex md:flex-wrap md:justify-between   bg-[#f8f8f8]  ">
        ...
        <div class="w-full md:w-1/2 mb-8 border border-solid border-[#e2e9e1] p-7">
            ...
            <table class="border-collapse w-full mb-5 ">
                <tr class="">
                    ...
                    <td class="w-1/2 border border-solid border-[#e2e9e1] p-2.5 text-[13px]">$0.00</td>
                </tr>
                <tr class="">
                ...
                <tr class="">
                    ...
                    <td class="w-1/2 border border-solid border-[#e2e9e1] p-2.5 text-[13px]"><strong>$0.00</strong></td>
                </tr>
            </table>
            <button
                class="feature-shadow w-48 mb-2  h-[46px] font-none text-white cursor-pointer hover:bg-[#50a6a0] bg-[#088178] outline-none transition duration-300  border border-solid border-amber-50">Proceed
                To Chekout</button>
        </div>
    </section>
