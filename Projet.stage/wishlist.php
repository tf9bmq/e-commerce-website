...
<body class="font-quick">
    ...
    <div class="p-6 mt-12  bg-[#f8f8f8] h-full">
        <h1 class="text-3xl font-bold mb-6">My Wishlist</h1>
        <p class="mb-5 font-medium ">These are your wishlist items</p>

        <?php if (empty($products)) : ?>
            <p class="text-gray-600 text-center justify-center">Your wishlist is empty.</p>
        <?php else: ?>
    ...
    <section
        class=" font-quick  w-full h-[220px] md:h-[30vh] flex text-cyan-50 justify-between flex-wrap  items-center pl-16 bg-[#041e42] bg-[url(./images/banner/b14.png)] bg-position-[20%]  bg-no-repeat bg-cover  ">
        <div class="">
